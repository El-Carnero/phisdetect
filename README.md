...
<p align="center">
  <img src="previews/scanner.png" alt="The URL, email and QR scanners" width="720"/>
  <br/>
  <em>Scan a URL, paste an email, or point your camera at a QR code.</em>
</p>

<p align="center">
  <img src="previews/dashboard.png" alt="The terminal-style dashboard" width="720"/>
  <br/>
  <em>A terminal-style dashboard of your scans, threats found, and points earned.</em>
</p>

<p align="center">
  <img src="previews/minigames.png" alt="The phishing-training minigames" width="720"/>
  <br/>
  <em>Three short games that teach you to spot phishing tricks.</em>
</p>

<p align="center">
  <img src="previews/sample-email-report.png" alt="A sample email scan report" width="720"/>
  <br/>
  <em>Every scan ends with a verdict and the reasons behind it.</em>
</p>
...
| **Profile** | Your name, points, and threat reports — saved in your browser as a guest, or on your account if you sign in. |
...
|-------|-------|------|--------------|
| Main phishing model | 103 hand-crafted URL features | Random Forest + calibration | ~403 MB |
| URL text model | The raw URL string as text | TF-IDF + Logistic Regression | ~6.4 MB |
| Email text model | The email's subject + body | TF-IDF + Logistic Regression | ~4.7 MB |

---

## Points, reports, and the leaderboard

- **No account needed:** as a guest, your name, points, reports and rank are
  saved in your browser (localStorage) — the app works with zero sign-up.
- **Optional account:** sign up or log in and your points and reports are
  stored on the server (MongoDB) so they follow you across browsers. Points are
  computed as **reports × 10 + minigame points**.
...
- **Leaderboard:** the top 5 scores for each game and difficulty are saved by
  the backend to a MongoDB database and shown on the minigames page. If you
  skip the database setup, the scanner works perfectly — only the account and
...
model\venv\Scripts\activate                  # Windows — do this in every terminal
source model/venv/bin/activate               # Mac / Linux — do this in every terminal

python -m pip install -r model/requirements.txt

python model/src/train.py                    # 10–40 minutes — the slow step, be patient
...
python frontend/serve.py                     # terminal 2 — the web app
# then open http://localhost:8000 in your browser
```

The trained models are too large for GitHub (the main one is ~403 MB), so they
...
- **Storage:** MongoDB (optional) for accounts, scan history, threat reports
  and the leaderboard — configured via `backend/.env`
